...
public class GpsTrackerBootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences("com.berwick.gpstracker.prefs", Context.MODE_PRIVATE);
        ...
        Log.i(TAG, "intervalInMinutes : " + intervalInMinutes);
